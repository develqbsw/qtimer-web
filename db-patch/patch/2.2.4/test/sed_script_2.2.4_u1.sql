...
GRANT ALL ON TABLE v_employees_status TO qtimertest_adm;
GRANT SELECT ON TABLE v_employees_status TO qtimertest_gw;
GRANT SELECT ON TABLE v_employees_status TO qtimertest_preview;
