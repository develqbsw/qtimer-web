...
GRANT ALL ON TABLE t_request_notification TO qtimertest_adm;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE t_request_notification TO qtimertest_gw;
GRANT SELECT ON TABLE t_request_notification TO qtimertest_preview;
...
ALTER TABLE t_ct_home_office_permission
  OWNER TO qtimertest_adm;
GRANT ALL ON TABLE t_ct_home_office_permission TO qtimertest_adm;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE t_ct_home_office_permission TO qtimertest_gw;
GRANT SELECT ON TABLE t_ct_home_office_permission TO qtimertest_preview;
...
ALTER TABLE v_timestamps
  OWNER TO qtimertest_adm;
GRANT ALL ON TABLE v_timestamps TO qtimertest_adm;
GRANT SELECT ON TABLE v_timestamps TO qtimertest_gw;
GRANT SELECT ON TABLE v_timestamps TO qtimertest_preview;
