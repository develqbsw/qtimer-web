...
ALTER TABLE v_week_sheet
  OWNER TO qtimertest_adm;
GRANT ALL ON TABLE v_week_sheet TO qtimertest_adm;
GRANT SELECT ON TABLE v_week_sheet TO qtimertest_gw;
GRANT SELECT ON TABLE v_week_sheet TO qtimertest_preview;
...
ALTER FUNCTION f_sed_get_working_time(numeric, timestamp without time zone, timestamp without time zone)
  OWNER TO qtimertest_adm;
GRANT EXECUTE ON FUNCTION f_sed_get_working_time(numeric, timestamp without time zone, timestamp without time zone) TO qtimertest_adm;
...
GRANT EXECUTE ON FUNCTION f_sed_get_working_time(numeric, timestamp without time zone, timestamp without time zone) TO qtimertest_gw;
...
ALTER TABLE t_ct_type_of_employment
  OWNER TO qtimertest_adm;
GRANT ALL ON TABLE t_ct_type_of_employment TO qtimertest_adm;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE t_ct_type_of_employment TO qtimertest_gw;
GRANT SELECT ON TABLE t_ct_type_of_employment TO qtimertest_preview;
...
ALTER FUNCTION f_archiver()
  OWNER TO qtimertest_adm;
GRANT EXECUTE ON FUNCTION f_archiver() TO qtimertest_adm;
GRANT EXECUTE ON FUNCTION f_archiver() TO public;
GRANT EXECUTE ON FUNCTION f_archiver() TO qtimertest_gw;
...
update t_user
   set fk_type_of_employment = 3
 where fk_client = 107
   and c_emp_code in ('320', '323', '348', '346', '349', '357', '356');
   
update t_user
   set fk_type_of_employment = 1
 where fk_client = 107
 and c_emp_code in ('275', '307', '291', '121', '212', '342', '40', '326', '6', '228', '213', '319', '32', '226', '340', '71', '237', '150', '191', '309', '292', '308', '239', '322', '317', '314', '221', '5', '236', '246', '168', '352', '220', '336', '328', '209', '205', '301', '219', '148', '316', '92', '55', '251', '244', '313', '185', '207', '186', '341', '211', '2', '179', '200', '327', '254', '335', '208', '206', '264', '298', '312', '182', '22', '325', '305', '355', '11', '100', '290', '329', '234', '30', '204', '62', '24', '16', '181', '81', '343', '315', '310', '347', '300', '94', '35', '339', '218', '344', '277', '29', '34', '27', '286', '93', '227', '217');

update t_user
   set fk_type_of_employment = 2
 where fk_client = 107
 and c_emp_code in ('235', '135', '61', '106', '260', '21', '3', '120', '180', '24', '214', '223', '10', '203', '259', '17', '293', '294', '334', '242');
...
ALTER TABLE v_organization_tree
  OWNER TO qtimertest_adm;
GRANT ALL ON TABLE v_organization_tree TO qtimertest_adm;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE v_organization_tree TO qtimertest_gw;
GRANT SELECT ON TABLE v_organization_tree TO qtimertest_preview;
...
ALTER TABLE v_employees
  OWNER TO qtimertest_adm;
GRANT ALL ON TABLE v_employees TO qtimertest_adm;
GRANT SELECT ON TABLE v_employees TO qtimertest_gw;
GRANT SELECT ON TABLE v_employees TO qtimertest_preview;