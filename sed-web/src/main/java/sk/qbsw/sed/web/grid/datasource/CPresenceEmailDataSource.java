...
public class CPresenceEmailDataSource implements IDataSource<CUserSystemEmailRecord> {
	...
	public CPresenceEmailDataSource(CompoundPropertyModel<CUserSystemEmailFilterCriteria> userFilterModel) {
	...
	public void loadData() {
		try {
			dataList = userService.getAccounts4SystemEmail();
