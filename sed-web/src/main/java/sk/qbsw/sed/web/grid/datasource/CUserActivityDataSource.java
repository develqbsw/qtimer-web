...
public class CUserActivityDataSource implements IDataSource<CUserActivityRecord> {

	private static final long serialVersionUID = 1L;

	@SpringBean
	private IBrwUserActivityService service;

	private final int itemsPerPage;

	private final IModel<CActivityBrwFilterCriteria> filterModel;
	 ...
	 */
	public CUserActivityDataSource(CompoundPropertyModel<CActivityBrwFilterCriteria> projectFilterModel) {
	 ...
	 */
	@Override
	public IModel<CUserActivityRecord> model(CUserActivityRecord object) {
	 ...
	 */
	@Override
	public void query(IQuery query, IQueryResult<CUserActivityRecord> result) {
		...
		List<CUserActivityRecord> resultList = null;
		Long count = null;
		...
		try {
			...
			Logger.getLogger(CUserActivityDataSource.class).error(e);
