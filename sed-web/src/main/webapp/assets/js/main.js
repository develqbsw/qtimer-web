...
var Main = function() {
    ...
    var runQTimerCheck = function() {
        if ($.fn.iCheck) {
            if ($('input[type="checkbox"]').length || $('input[type="radio"]').length) {
                $('input[type="checkbox"].grey-q-timer, input[type="radio"].grey-q-timer').on('ifCreated ifClicked ifChanged ifChecked ifUnchecked ifDisabled ifEnabled ifDestroyed check ', function(event){                
    ...
    return {
    	runCustomCheck: function() {
    		runCustomCheck();
    	},
    	
    	runQTimerCheck: function() {
    		runQTimerCheck();
    	},
    	
    	runPanelScroll: function() {
    		runPanelScroll();
		},
