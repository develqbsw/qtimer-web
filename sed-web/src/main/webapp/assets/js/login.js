var Login = function() {
	...
	var runLoginButtons = function() {
		$('.licence').on('click', function() {
			...
			$('.box-licence').show().addClass("animated bounceInLeft").on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
		...
		$('.registerR').on('click', function() {
			$('.box-licence').removeClass("animated flipInX").addClass("animated bounceOutLeft").on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
				$(this).hide().removeClass("animated bounceOutLeft");

			});
			$('.box-register').show().addClass("animated bounceInRight").on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
