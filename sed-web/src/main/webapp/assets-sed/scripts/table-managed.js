var TableManaged = function () {
    ...
    return {
        ...
        init: function () {
			...
			/*********** start qbsw ************/
			jQuery('#sample_2_wrapper .row-fluid .span8').append('<div class="control-group"><div class="controls"><input type="hidden" id="select2_application" data-placeholder="Choose an Application" class="span6 select2"></div></div>');
			/*********** end qbsw ************/
