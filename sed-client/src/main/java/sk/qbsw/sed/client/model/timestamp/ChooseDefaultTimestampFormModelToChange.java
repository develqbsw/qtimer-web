...
public class ChooseDefaultTimestampFormModelToChange implements Serializable {

	private static final long serialVersionUID = 1L;

	public ChooseDefaultTimestampFormModelToChange(CCodeListRecord activity, CCodeListRecord project, String phase, String note, Boolean activityChecked, Boolean projectChecked, Boolean phaseChecked,
			Boolean noteChecked) {
		super();
