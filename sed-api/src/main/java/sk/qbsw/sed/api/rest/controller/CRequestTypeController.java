...
public class CRequestTypeController extends AController {

	@Autowired
	private IRequestTypeService requestTypeService;

	public CRequestTypeController() {
	...
	public void getValidRecords(@RequestBody String json, HttpServletResponse response) throws CApiException {
		...
		List<CCodeListRecord> codeListRecord = requestTypeService.getValidRecords(false);
	...
	@RequestMapping("getValidRecordsForRequestReason")
	public void getValidRecordsForRequestReason(@RequestBody String json, HttpServletResponse response) throws CApiException {
		CResponse<CCodeListRecordResponseContent> responseData = new CResponse<>();
		CCodeListRecordResponseContent content = new CCodeListRecordResponseContent();

		List<CCodeListRecord> codeListRecord = requestTypeService.getValidRecordsForRequestReason();
